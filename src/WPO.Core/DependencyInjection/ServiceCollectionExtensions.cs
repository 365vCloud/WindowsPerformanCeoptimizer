...
public static class ServiceCollectionExtensions
{
        ...
        Action<PathSafetyOptions>? configurePathSafety = null)
    {
        ...
        services.AddSingleton<IAuditLogService, LocalAuditLogService>();
        services.AddSingleton<IAuditLogger>(provider => provider.GetRequiredService<IAuditLogService>());
        services.AddSingleton<IAuditLogExporter, AuditLogExporter>();
        services.AddSingleton<IExportService, CleanupResultExportService>();
